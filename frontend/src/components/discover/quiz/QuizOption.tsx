...
export function QuizOption({ option, isSelected, theme, onClick }: QuizOptionProps) {
  return (
    <button
      onClick={onClick}
      className={`w-full px-4 py-3 rounded-xl text-sm font-medium transition-all duration-200 border text-left flex justify-between items-center border-2 ${isSelected
